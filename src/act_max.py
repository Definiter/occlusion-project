...
fc_layers = ["fc6", "fc7", "fc8", "loss3/classifier", "fc1000", "prob", "fc8_occlusion"]
...
def get_code(path, layer):
  ...
  matfile = scipy.io.loadmat('/home/haow3/occlusion-project/src/nets/ilsvrc_2012_mean.mat')
