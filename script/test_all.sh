...
do
    ...
    do
        ...
        do
            ...
            sleep 30s
            qsub -q taising -v gpu=0,model_type_str=${model_type_str},model_name=${model_name},test_type_str=${test_type_str},test_name=60 -l nodes=compute-1-5  -N ${model_type_str}_${model_name}_${test_type_str}_60 pbs_test.script
            sleep 30s
            #qsub -q taising -v gpu=1,model_type_str=${model_type_str},model_name=${model_name},test_type_str=${test_type_str},test_name=80 -l nodes=compute-1-5  -N ${model_type_str}_${model_name}_${test_type_str}_80 pbs_test.script
            #sleep 30s
            qsub -q taising -v gpu=2,model_type_str=${model_type_str},model_name=${model_name},test_type_str=${test_type_str},test_name=100 -l nodes=compute-1-5 -N ${model_type_str}_${model_name}_${test_type_str}_100  pbs_test.script
            #sleep 30s
            echo ---
        done
    done
