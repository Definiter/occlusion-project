...
model_names=(all)
#test_type_strs=(crop_obj crop_img crop aperture nocrop)
...
do
    ...
    do
        ...
        do
            ...
            sleep 10
            qsub -q taising -v gpu=1,model_type_str=${model_type_str},model_name=${model_name},test_type_str=${test_type_str},test_name=90 -l nodes=compute-1-1  -N ${model_type_str}_${model_name}_${test_type_str}_90_test pbs_test.script
            sleep 10
