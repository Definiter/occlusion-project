...
model_names=(all)
test_type_strs=(aperture crop_obj)
...
do
    ...
    do
        ...
        do
            ...
            sleep 10
            qsub -q taising -v gpu=2,model_type_str=${model_type_str},model_name=${model_name},test_type_str=${test_type_str},test_name=100 -l nodes=compute-1-1  -N ${model_type_str}_${model_name}_${test_type_str}_100_img2vec pbs_img2vec.script
            sleep 10
            echo ---
        done
    done
