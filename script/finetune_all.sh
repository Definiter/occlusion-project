...
do
    ...
    qsub -q taising -v gpu=3,net_name=50,type_str=$model_str   -l nodes=compute-1-1 pbs_finetune.script 
    qsub -q taising -v gpu=2,net_name=100,type_str=$model_str   -l nodes=compute-1-3 pbs_finetune.script 
    qsub -q taising -v gpu=3,net_name=all,type_str=$model_str   -l nodes=compute-1-3 pbs_finetune.script 
