model_type_strs=(1k_nocrop_obj)

for model_type_str in "${model_type_strs[@]}"
do
    echo $model_type_str
    qsub -q taising -v gpu=0,model_name=0,model_type_str=$model_type_str   -l nodes=compute-1-1 -N $model_type_str\_0\_finetune pbs_finetune.script 
    qsub -q taising -v gpu=1,model_name=20,model_type_str=$model_type_str  -l nodes=compute-1-1 -N $model_type_str\_20\_finetune pbs_finetune.script 
    qsub -q taising -v gpu=2,model_name=40,model_type_str=$model_type_str  -l nodes=compute-1-1 -N $model_type_str\_40\_finetune pbs_finetune.script 
    qsub -q taising -v gpu=3,model_name=60,model_type_str=$model_type_str  -l nodes=compute-1-1 -N $model_type_str\_60\_finetune pbs_finetune.script 
    qsub -q taising -v gpu=0,model_name=80,model_type_str=$model_type_str  -l nodes=compute-1-1 -N $model_type_str\_80\_finetune pbs_finetune.script 
    qsub -q taising -v gpu=1,model_name=100,model_type_str=$model_type_str -l nodes=compute-1-1 -N $model_type_str\_100\_finetune pbs_finetune.script 
    qsub -q taising -v gpu=2,model_name=all,model_type_str=$model_type_str -l nodes=compute-1-1 -N $model_type_str\_all\_finetune pbs_finetune.script 
